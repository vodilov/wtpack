...
func vunpack_posint(buf []byte, bcur *int, bend int) (uint64, error) {
	var x uint64
...
func vunpack_negint(buf []byte, bcur *int, bend int) (uint64, error) {
	var x uint64
...
func vunpack_uint(buf []byte, bcur *int, bend int) (uint64, error) {
...
func vunpack_int(buf []byte, bcur *int, bend int) (int64, error) {
	switch buf[*bcur] & 0xF0 {
